...
# Further modification by Adam Wickert to automate through Jamf for migration to  NoMAD on existing systems vi self service
#
# Migrates an Active Directory mobile account to a local account by the following process:
# 1. Specified account through Self Service login
